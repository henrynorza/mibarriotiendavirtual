...
<%
    ...
    switch(proceso){
        case "guardarProducto":
            //debido a que creamos el siguiente parametro como int en Contacto.java y en la DB, lo vamos a convertir a entero
        ...
        case "listarProductos":
            ...
            if(listaProductos.isEmpty()){
                ...
                respuesta += "\"" + proceso + "\":true,\"Contactos\":"+ new Gson().toJson(listaProductos);
            }
            break;
        case "obtenerProducto":
            ...
            if(productoi==null){
                respuesta += "\"" + proceso + "\":false,\"Contacto\":";
            }else{
                respuesta += "\"" + proceso + "\":true,\"Contacto\":"+new Gson().toJson(productoi);
            }
            break;
        default:
            respuesta += "\"ok\": false,";
